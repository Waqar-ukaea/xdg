...
int main(int argc, char** argv) {
  ...
  argparse::ArgumentParser args("XDG/cuBQL BVH robustness testing", "1.0", argparse::default_arguments::help);
...
if (mesh_str == "MOAB")
  ...
  if (use_batch) {
    ...
    // we are on a miss/failed BVH traversal so lets do additional diagnostics
